...
public abstract class WireMockBaseTest extends AbstractBaseIntegrationTest {
    ...
    public static final String CASE_01_ID = "1";
    public static final String CASE_02_ID = "2";
    public static final String CASE_04_ID = "4";
    public static final String CASE_13_ID = "13";
    public static final String CASE_14_ID = "14";
    public static final String CASE_19_ID = "19";
    public static final String CASE_21_ID = "21";
    public static final String CASE_22_ID = "22";
    public static final String CASE_03_ID = "3";
