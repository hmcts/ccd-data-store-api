...
public abstract class WireMockBaseTest extends AbstractBaseIntegrationTest {
    ...
    public static final String CASE_01_ID = "1L";
    public static final String CASE_02_ID = "2L";
    public static final String CASE_04_ID = "4L";
    public static final String CASE_13_ID = "13L";
    public static final String CASE_14_ID = "14L";
    public static final String CASE_19_ID = "19L";
    public static final String CASE_21_ID = "21L";
    public static final String CASE_22_ID = "22L";
    public static final String CASE_03_ID = "3L";
