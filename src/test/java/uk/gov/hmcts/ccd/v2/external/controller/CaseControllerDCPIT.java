...
class CaseControllerDCPIT extends WireMockBaseTest {
    ...
    @Test
    void shouldCreateCaseWithFormattedDCPValues() throws Exception {
    ...
    private void assertCaseDataResultSetSize() {
        ...
        assertThat(count).isEqualTo(NUMBER_OF_CASES);
    }
}
