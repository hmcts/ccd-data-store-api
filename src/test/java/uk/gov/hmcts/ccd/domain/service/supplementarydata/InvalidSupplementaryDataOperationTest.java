...
class InvalidSupplementaryDataOperationTest {
    ...
    void setUp() {
        ...
        doReturn(List.of(CASE_TYPE)).when(applicationParams).getInvalidSupplementaryDataCaseTypes();

        this.instance = new InvalidSupplementaryDataOperation(applicationParams, caseDetailsRepository, mapper);
    }
