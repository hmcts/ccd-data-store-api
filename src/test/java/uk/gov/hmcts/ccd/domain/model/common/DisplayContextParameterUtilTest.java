...
class DisplayContextParameterUtilTest {
    ...
    void shouldUpdateParameter() {
        assertAll(
            () -> assertThat(updateCollectionDisplayContextParameter("#COLLECTION(allowInsert,allowDelete)",
                asList("allowInsert", "allowDelete")),
                is("#COLLECTION(allowDelete,allowInsert)")),
            () -> assertThat(updateCollectionDisplayContextParameter("#COLLECTION(allowInsert)",
                asList("allowInsert", "allowDelete")),
                is("#COLLECTION(allowDelete,allowInsert)")),
            () -> assertThat(updateCollectionDisplayContextParameter("#COLLECTION(allowInsert,allowDelete)",
                asList("allowDelete", "allowInsert")),
                is("#COLLECTION(allowDelete,allowInsert)")),
            () -> assertThat(updateCollectionDisplayContextParameter("#COLLECTION(allowInsert,allowDelete)",
                asList("allowDelete")),
                is("#COLLECTION(allowDelete)")),
            () -> assertThat(updateCollectionDisplayContextParameter(
                "#COLLECTION(other,allowInsert,allowDelete, other2)", asList("allowDelete")),
    ...
    void shouldUpdateParameterMultiple() {
        assertAll(
            () -> assertThat(
                updateCollectionDisplayContextParameter("#TABLE()", asList("allowInsert", "allowDelete")),
                is("#TABLE(),#COLLECTION(allowDelete,allowInsert)")
            ),
            () -> assertThat(
                updateCollectionDisplayContextParameter("#TABLE(),#COLLECTION(allowInsert,allowDelete)",
                    asList("allowDelete")),
                is("#TABLE(),#COLLECTION(allowDelete)")
            ),
            () -> assertThat(
                updateCollectionDisplayContextParameter("#TABLE(),#COLLECTION(other,allowInsert,allowDelete)",
                    asList("allowDelete")),
                is("#TABLE(),#COLLECTION(allowDelete,other)")
            ),
            () -> assertThat(
                updateCollectionDisplayContextParameter("#TABLE(postcode),#COLLECTION(other,allowInsert,allowDelete)",
                    asList("allowDelete")),
    ...
    void shouldUpdateParameterWithSpaces() {
        assertAll(
            () -> assertThat(
                updateCollectionDisplayContextParameter("#TABLE( other  ),#COLLECTION(allowInsert ,  allowDelete )",
                    asList("allowDelete")),
    ...
    void shouldRemoveDuplicatesFromParameterValues() {
        assertAll(
            () -> assertThat(
                updateCollectionDisplayContextParameter("#COLLECTION(allowInsert,allowDelete)", asList("allowDelete",
