...
class AuthorisedGetCaseViewOperationTest {
    ...
    private static final CaseEvent CASE_EVENT = aCaseEvent().withId(EVENT_ID_STRING).build();
    private static final CaseEvent CASE_EVENT_2 = aCaseEvent().withId("event2").build();
