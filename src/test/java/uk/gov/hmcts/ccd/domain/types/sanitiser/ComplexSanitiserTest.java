...
public class ComplexSanitiserTest {
    ...
    private static final JsonNode FIELD_1_VALUE_INITIAL = JSON_FACTORY.stringNode("Initial value 1");
    private static final JsonNode FIELD_1_VALUE_SANITISED = JSON_FACTORY.stringNode("Sanitised value 1");
    ...
    private static final JsonNode FIELD_2_VALUE_INITIAL = JSON_FACTORY.stringNode("Initial value 2");
    private static final JsonNode FIELD_2_VALUE_SANITISED = JSON_FACTORY.stringNode("Sanitised value 2");
