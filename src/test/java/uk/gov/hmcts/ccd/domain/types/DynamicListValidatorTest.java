...
class DynamicListValidatorTest {
    ...
    void invalidValue() throws Exception{
        JsonNode dataValue = new ObjectMapper().readTree("{\n" +
            ...
            "          },\n" +
            "          \"dynamic_list_items\": [{\n" +
            "            \"code\": \"FixedList1FixedList1FixedList1FixedList1FixedList1FixedList1FixedList1FixedList1FixedList1FixedList1FixedList1FixedList1FixedList1FixedList1FixedList1FixedList1FixedList1FixedList1FixedList1FixedList1\",\n" +
            "            \"label\": \"Fixed List 1\"\n" +
            "          }, {\n" +
            "            \"code\": \"FixedList2\",\n" +
            "            \"label\": \"Fixed List 2\"\n" +
