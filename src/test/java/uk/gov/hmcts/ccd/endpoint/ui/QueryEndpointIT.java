...
public class QueryEndpointIT extends WireMockBaseTest {
    ...
    public void validGetCase() throws Exception {
        ...
        assertEquals("Unexpected tab show condition", "NameTabShowCondition", nameTab.getShowCondition());
        ...
        assertEquals("Unexpected Field show condition", "PersonFirstNameFieldShowCondition", firstNameField.getShowCondition());
        ...
        assertEquals("Unexpected Field show condition", "PersonLastNameFieldShowCondition", lastNameField.getShowCondition());
        ...
        assertEquals("Unexpected tab show condition", "AddressTabShowCondition", addressTab.getShowCondition());
        ...
        assertEquals("Unexpected Field show condition", "PersonAddressFieldShowCondition", addressField.getShowCondition());
        ...
        assertEquals("Unexpected tab show condition", "DocumentsTabShowCondition", documentTab.getShowCondition());
        ...
        assertEquals("Unexpected Field show condition", "D8DocumentsFieldShowCondition", documentField.getShowCondition());
