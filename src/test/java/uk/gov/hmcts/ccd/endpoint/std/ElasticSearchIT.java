...
class ElasticSearchIT extends ElasticsearchBaseTest {
    ...
    class UICaseSearchController {
        ...
        void shouldReturnAllCaseDetailsForDefaultUseCase() throws Exception {
            ...
            CaseSearchResultViewResource caseSearchResultViewResource = executeRequest(searchRequest,
                CASE_TYPE_A,
                null);
        ...
        void shouldReturnAllHeaderInfoForDefaultUseCaseWhenUserHasSomeAuthorisationOnCaseFields() throws Exception {
            ...
            assertAll(
                ...
                () -> expectedFields.forEach(f ->
                    assertThat(caseSearchResultViewResource.getHeaders().get(0).getFields(),
        ...
        private JsonNode executeErrorRequest(ElasticsearchTestRequest searchRequest,
            ...
            MockHttpServletRequestBuilder postRequest = createPostRequest(POST_SEARCH_CASES,
                searchRequest,
                caseTypeParam,
                useCase);

            return ElasticsearchTestHelper.executeRequest(postRequest,
                expectedErrorCode,
                mapper,
                mockMvc,
                JsonNode.class);
