...
public class AMCaseUserRepositoryTest extends BaseTest {
    ...
    public void setUp() {
        ...
        ResourceDefinition resourceDefinition =
            ...
            new ResourceDefinition(JURISDICTION_ID, "case", CASE_TYPE_ID);
    ...
    public void shouldGrantAccessAsCustomCaseRole() {
        repository.grantAccess(JURISDICTION_ID, CASE_TYPE_ID, CASE_TYPE_ID, CASE_ID, USER_ID, CASE_ROLE);
    ...
    public void shouldRevokeAccessAsCustomCaseRole() {
        repository.grantAccess(JURISDICTION_ID, CASE_TYPE_ID, CASE_TYPE_ID, CASE_ID, USER_ID, CASE_ROLE);
        repository.revokeAccess(JURISDICTION_ID, CASE_TYPE_ID, CASE_TYPE_ID, CASE_ID, USER_ID, CASE_ROLE);
    ...
    public void shouldFindCasesUserIdHasAccessTo() {
        ...
        repository.grantAccess(JURISDICTION_ID, CASE_TYPE_ID, CASE_TYPE_ID, CASE_ID, USER_ID_GRANTED, CASE_ROLE);
        repository.grantAccess(JURISDICTION_ID, CASE_TYPE_ID, CASE_TYPE_ID, CASE_ID_3, USER_ID_GRANTED, CASE_ROLE);
        repository.grantAccess(JURISDICTION_ID, CASE_TYPE_ID, CASE_TYPE_ID, CASE_ID_GRANTED, USER_ID_GRANTED, CASE_ROLE);
    ...
    public void shouldFindCaseRolesUserPerformsForCase() {
        repository.grantAccess(JURISDICTION_ID, CASE_TYPE_ID, CASE_TYPE_ID, CASE_ID, USER_ID, CASE_ROLE_CREATOR);
        ...
        repository.grantAccess(JURISDICTION_ID, CASE_TYPE_ID, CASE_TYPE_ID, CASE_ID, USER_ID, CASE_ROLE);
        repository.grantAccess(JURISDICTION_ID, CASE_TYPE_ID, CASE_TYPE_ID, CASE_ID, USER_ID, CASE_ROLE_CREATOR);
        repository.grantAccess(JURISDICTION_ID, CASE_TYPE_ID, CASE_TYPE_ID, CASE_ID, USER_ID, CASE_ROLE_SOLICITOR);
