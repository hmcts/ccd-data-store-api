...
import static uk.gov.hmcts.ccd.data.casedataaccesscontrol.DefaultRoleAssignmentRepository.AM_TOTAL_RECORDS;
...
public class DefaultRoleAssignmentRepositoryTest {
    ...
    private static final String TEST_PAGE_STARTING_NUMBER = "0";
    ...
    void setUp() {
        ...
        when(applicationParams.getAmRoleAssignmentStartingPageNumber()).thenReturn(TEST_PAGE_STARTING_NUMBER);
        when(applicationParams.getAmRoleAssignmentPageSize()).thenReturn(TEST_PAGE_SIZE);
    ...
    void shouldReturnRoleAssignmentsByUserAndRoles() {
        when(applicationParams.isAmRoleAssignmentPaginationEnabled()).thenReturn(false);
    ...
    void shouldReturnRoleAssignmentsByUserAndRolesWithPagination() {
        when(applicationParams.isAmRoleAssignmentPaginationEnabled()).thenReturn(true);
    ...
    private static HttpHeaders responseHeaders() {
        ...
        headers.add(AM_TOTAL_RECORDS, TEST_TOTAL_RECORDS);
        return headers;
    }
