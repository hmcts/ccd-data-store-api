...
4. Copy and run the script `logstash_re_indexing_query.sql` (this queues cases in `case_data_logstash_queue`, which in turn will trigger the indexing process)
