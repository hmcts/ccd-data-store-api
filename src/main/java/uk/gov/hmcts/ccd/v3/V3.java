...
public final class V3 {
    ...
    public static final String EXPERIMENTAL_WARNING = "Experimental! Subject to change or removal,"
    ...
    public static final class MediaType {
        ...
        // External API
        public static final String CREATE_EVENT = "application/vnd.uk.gov.hmcts.ccd-data-store-api."
            + "create-event.v3+json;charset=UTF-8";
        public static final String CREATE_CASE = "application/vnd.uk.gov.hmcts.ccd-data-store-api."
            +  "create-case.v3+json;charset=UTF-8";
    }
