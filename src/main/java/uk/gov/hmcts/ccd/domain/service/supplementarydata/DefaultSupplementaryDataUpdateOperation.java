...
public class DefaultSupplementaryDataUpdateOperation implements SupplementaryDataUpdateOperation {
    ...
    @Autowired
    public DefaultSupplementaryDataUpdateOperation(final @Qualifier("default") SupplementaryDataRepository
        ...
        supplementaryFunctions.put(SET, (caseReference, updateRequest) -> {
            ...
            for (Map.Entry<String, Object> pathValuePair : requestedProperties.entrySet()) {
                this.supplementaryDataRepository.setSupplementaryData(caseReference, pathValuePair.getKey(),
                    pathValuePair.getValue());
            }
        });
        supplementaryFunctions.put(INC, (caseReference, updateRequest) -> {
            ...
            for (Map.Entry<String, Object> pathValuePair : requestedProperties.entrySet()) {
                this.supplementaryDataRepository.incrementSupplementaryData(caseReference, pathValuePair.getKey(),
                    pathValuePair.getValue());
            }
        });
    }
