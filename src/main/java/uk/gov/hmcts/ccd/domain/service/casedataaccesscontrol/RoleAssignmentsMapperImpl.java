...
public class RoleAssignmentsMapperImpl implements RoleAssignmentsMapper {
    ...
    public RoleAssignments toRoleAssignments(RoleAssignmentResponse roleAssignmentResponse) {
        ...
        roleAssignments.roleAssignments( roleAssignmentResourceListToRoleAssignmentList( roleAssignmentResponse.getRoleAssignments() ) );

        return roleAssignments.build();
    }

    protected RoleAssignmentAttributes roleAssignmentAttributesResourceToRoleAssignmentAttributes(RoleAssignmentAttributesResource roleAssignmentAttributesResource) {
    ...
    protected RoleAssignment roleAssignmentResourceToRoleAssignment(RoleAssignmentResource roleAssignmentResource) {
        ...
        roleAssignment.attributes( roleAssignmentAttributesResourceToRoleAssignmentAttributes( roleAssignmentResource.getAttributes() ) );
