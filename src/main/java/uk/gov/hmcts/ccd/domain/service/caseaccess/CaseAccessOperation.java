...
public class CaseAccessOperation {
    ...
    public void grantAccess(final String jurisdictionId, final String caseReference, final String userId) {
        ...
        caseUserRepository.grantAccess(jurisdictionId, caseDetails.getCaseTypeId(), Long.valueOf(caseDetails.getId()), userId, CREATOR.getRole());
    }
    ...
    public void revokeAccess(final String jurisdictionId, final String caseReference, final String userId) {
        final Optional<CaseDetails> maybeCase = caseDetailsRepository.findByReference(jurisdictionId,
            Long.valueOf(caseReference));
        final CaseDetails caseDetails = maybeCase.orElseThrow(() -> new CaseNotFoundException(caseReference));
        caseUserRepository.revokeAccess(jurisdictionId, caseDetails.getCaseTypeId(), Long.valueOf(caseDetails.getId()), userId, CREATOR.getRole());
    }
    ...
    public void updateUserAccess(CaseDetails caseDetails, CaseUser caseUser) {
        ...
        grantAddedCaseRoles(caseDetails.getJurisdiction(), caseDetails.getCaseTypeId(), userId, caseId, currentCaseRoles, targetCaseRoles);
        revokeRemovedCaseRoles(caseDetails.getJurisdiction(), caseDetails.getCaseTypeId(), userId, caseId, currentCaseRoles, targetCaseRoles);
    }
    ...
    private void grantAddedCaseRoles(final String jurisdictionId,
        ...
        targetCaseRoles.stream()
            ...
            .forEach(targetRole -> caseUserRepository.grantAccess(jurisdictionId, caseTypeId, caseId, userId, targetRole));
    }
    ...
    private void revokeRemovedCaseRoles(final String jurisdictionId,
        ...
        currentCaseRoles.stream()
            ...
            .forEach(currentRole -> caseUserRepository.revokeAccess(jurisdictionId, caseTypeId, caseId, userId, currentRole));
    }
}
