...
public final class V2 {
    ...
    public final class MediaType {
        ...
        public static final String START_CASE_EVENT =
        ...
        public static final String CASE_EVENTS =
            "application/vnd.uk.gov.hmcts.ccd-data-store-api.case-events.v2+json;charset=UTF-8";

        public static final String UI_CASE_ACCESS_METADATA =
            "application/vnd.uk.gov.hmcts.ccd-data-store-api.ui-case-access-metadata.v2+json;charset=UTF-8";
    ...
    public final class Error {
        ...
        public static final String EVENT_TRIGGER_NOT_KNOWN_FOR_CASE_TYPE =
            "Event trigger is not known for given case type";
        ...
        public static final String GRANT_FORBIDDEN =
            "Grant action is reserved to users with entire jurisdiction access";
        ...
        public static final String ORGANISATION_ID_MISMATCH = "Organisation ID does not match caller organisation";
