...
public interface CaseUserRepository {
    ...
    void grantAccess(String caseTypeId, Long caseId, String userId, String caseRole);

    void revokeAccess(String caseTypeId, Long caseId, String userId, String caseRole);
