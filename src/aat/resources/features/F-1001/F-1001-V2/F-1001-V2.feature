@F-1001-V2
Feature: F-1001-V2: Get Document AM Data for a given Case ID and Document ID (V2)
  ...
  Scenario: must successfully receive a document am data with a list of permissions
    ...
    And another successful call [by a privileged user with full ACL to create a case of this case type] as in [F-1001-V2_Case_Creation_Main]
...
#    @S-1004 @Ignore #Duplicate of S-1003. Not required any more.
