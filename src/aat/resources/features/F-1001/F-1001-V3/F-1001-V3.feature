@F-1001-V3
Feature: F-1001-V3: Get Document AM Data for a given Case ID and Document ID (V3)
  ...
  Scenario: must successfully receive a document am data with a list of permissions
    ...
    And another successful call [by a privileged user with full ACL to create a case of this case type] as in [F-1001-V3_Case_Creation_Main]
