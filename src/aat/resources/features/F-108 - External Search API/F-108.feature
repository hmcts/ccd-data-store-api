...
Feature: F-108: Elasticsearch external endpoint
  ...
  ### CrossCaseTypeSearch
  @S-910 @Ignore @Reenable #wait for RDM-10885 ro run this
  ...
  @S-912 @Ignore @Reenable #wait for RDM-10885 ro run this
  ...
  @S-913 @Ignore @Reenable #wait for RDM-10885 ro run this
  ...
  @S-914 @Ignore @Reenable #wait for RDM-10885 ro run this
  Scenario: should return the case field where user role matches ACL and security classification
  ...
  ### Field Search Tests
  @S-916 @Ignore @Reenable #wait for RDM-10885 ro run this
  ...
  @S-917 @Ignore @Reenable #wait for RDM-10885 ro run this
  ...
  @S-918 @Ignore @Reenable #wait for RDM-10885 ro run this
  ...
  @S-919 @Ignore @Reenable #wait for RDM-10885 ro run this
  ...
  @S-920 @Ignore @Reenable #wait for RDM-10885 ro run this
  ...
  @S-921 @Ignore @Reenable #wait for RDM-10885 ro run this
  ...
  @S-922 @Ignore @Reenable #wait for RDM-10885 ro run this
  ...
  @S-923 @Ignore @Reenable #wait for RDM-10885 ro run this
  ...
  @S-941 @Ignore @Reenable #wait for RDM-10885 ro run this
