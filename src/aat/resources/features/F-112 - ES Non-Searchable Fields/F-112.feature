@F-112 @elasticsearch
Feature: F-112: Allow ignoring fields in ES by declaring them non searchable
  ...
  @S-112.3 @Ignore @Reenable #wait for RDM-10885 ro run this
  ...
  @S-112.5 @Ignore @Reenable #wait for RDM-10885 ro run this
