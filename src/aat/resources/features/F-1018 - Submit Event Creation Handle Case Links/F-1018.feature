  ...
  Background: Load test data for the scenario
   ...
   #=======================================
    ...
    Given   a user with [an active profile in CCD]
      ...
      And   a successful call [to get an event token for the case just created] as in [F-1018-GetAnotherCaseUpdateEventToken]
      When  a request is prepared with appropriate values
   ...
   #=======================================
    ...
    Given   a user with [an active profile in CCD]
      ...
      And   a successful call [to get an update event token for the case just created as a Citizen] as in [F-1018-GetAnotherCitizenCaseUpdateEventToken]
      When  a request is prepared with appropriate values
