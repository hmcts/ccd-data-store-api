...
Feature: get case
  ...
  Scenario: Only fields with SC less than or equal to that of the actor are returned
    ...
    And a successful call [to give user Solicitor1 a PRIVATE CASE role assignment to view the previously created case J1-CT2-01] as in [GRANT_CASE_ROLE_ASSIGNMENT]
    When a request is prepared with appropriate values
