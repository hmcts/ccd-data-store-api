...
Feature: Elasticsearch external endpoint
  ...
  @S-600 @elasticsearch @ash #SC
#  Scenario: should NOT return the case field where user role has lower security classification than case field
...
#
##  @S-607  @ignore #todo
##  Scenario: should NOT return the case field where user role does not have read access on the field
##
##  @S-608  @ignore  #todo
