...
// Consolidated Pact Provider Rest Controller for "WA TASK MANAGEMENT" , version 1.   [Copied from CCD-5224]
...
public class CasesRestController {
    ...
    /*
     * Handle Pact State "a case exists".
     */
    @Operation(description = "a case exists",
